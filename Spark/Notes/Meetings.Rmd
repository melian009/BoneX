...
* Proposal of an Ecosystem Service matrix, in which services are organized in rows and columns represent species that contribute to the service. Based on this we can explore the structure of this matrix by:
