...
```{r functions, echo=FALSE, out.width="50%", fig.cap="Example of cost-benefit functions"}
...
```{r coexistence, echo=FALSE, out.width="50%", fig.cap="Porbability of species' persistence given the difference in benefits and costs"}
...
ggplot(diff_probs, aes(x = diff_values, y=probs)) +
  ...
  labs(x = "Difference between benefits and costs (B-C = D)",
       y = "Probabiliy of all species persisting P(D>0)",
       color = "Curve") +
  theme_bw()
